...
public class QuarterPlanDetailDto extends BaseDto {
    @ApiModelProperty("季度计划清单项编号")
    String quarterPlanDetailCode;

    @ApiModelProperty("季度计划")
    QuarterPlanDto quarterPlan;

    @ApiModelProperty("父项")
    QuarterPlanDetailDto parent;

    @ApiModelProperty("子项")
    List<QuarterPlanDetailDto> children = new ArrayList<>();
